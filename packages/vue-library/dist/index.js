...
const myComponent_js = require('@mifotest/stencil-library/dist/components/my-component.js');
...
const MyComponent = defineContainer('my-component', myComponent_js.defineCustomElement, [
    'first',
    'middle',
    'last'
]);
